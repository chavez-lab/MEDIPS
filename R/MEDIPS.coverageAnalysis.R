...
#MEDIPS.coverageAnalysis<-function(){
MEDIPS.coverageAnalysis<-function(data=NULL, coverages=c(1,2,3,4,5,10), no_iterations=10, no_random_iterations=1, extend=NULL){
	
	.Deprecated("MEDIPS.seqCoverage")

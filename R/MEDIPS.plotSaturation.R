...
function(saturationObj=NULL, main="Saturation analysis"){
	...
	##Plot	
	plot(estimation[,1], estimation[,2], type="l", col=colors[1], xlab="Number of reads", ylab="Pearson correlation coefficient", main=main, sub=paste("Saturation cor: ", round(maxTruCor[2], digits=2), "; Estimated cor: ", round(maxEstCor[2], digits=2), sep=""))
